...
- [x] Business P: Pop Vibrant は専用 worktree / branch で Phase 1 polish を実施し、ファミリー向け店舗・エンタメサービスの販促サイトとして CTA 導線、実サイト寄りコピー、静的構造を整理した。次候補は実装順どおり Business D: Dynamic
