# Streamer X: Xtreme Action Mock Prompt

## Purpose
- このファイルは streamer/x の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/full-renewal/x-xtreme-action.md`
...
---
version: "alpha"
name: "Streamer X: Xtreme Action"
description: "スポーツ/アクション配信者向けの公式サイト first viewport mock。大会予定、配信、スポンサー相談へつなぐ。"
colors:
  primary: "#fbbf24"
  secondary: "#000000"
  surface: "#78350f"
...
- The visual identity matches "Xtreme Action" and still feels like a usable website.
