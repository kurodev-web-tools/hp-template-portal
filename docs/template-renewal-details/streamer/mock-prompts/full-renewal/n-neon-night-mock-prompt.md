# Streamer N: Neon Night Mock Prompt

## Purpose
- このファイルは streamer/n の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/full-renewal/n-neon-night.md`
...
- The visual identity matches "Neon Night" and still feels like a usable website.
