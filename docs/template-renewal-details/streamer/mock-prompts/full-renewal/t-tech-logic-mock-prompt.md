# Streamer T: Tech Logic Mock Prompt

## Purpose
- このファイルは streamer/t の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/full-renewal/t-tech-logic.md`
...
- The visual identity matches "Tech Logic" and still feels like a usable website.
