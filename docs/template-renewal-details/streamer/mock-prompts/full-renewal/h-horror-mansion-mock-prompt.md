# Streamer H: Horror Mansion Mock Prompt

## Purpose
- このファイルは streamer/h の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/full-renewal/h-horror-mansion.md`
...
- The visual identity matches "Horror Mansion" and still feels like a usable website.
