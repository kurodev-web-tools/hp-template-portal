# Streamer J: Jazz Lounge Mock Prompt

## Purpose
- このファイルは streamer/j の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/full-renewal/j-jazz-lounge.md`
...
- The visual identity matches "Jazz Lounge" and still feels like a usable website.
