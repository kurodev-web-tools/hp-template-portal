# Streamer D: Digital Ghost Mock Prompt

## Purpose
- このファイルは streamer/d の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/full-renewal/d-digital-ghost.md`
...
- The visual identity matches "Digital Ghost" and still feels like a usable website.
