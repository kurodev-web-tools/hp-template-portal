# Streamer Z: Zen Brush Mock Prompt

## Purpose
- このファイルは streamer/z の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/polish/z-zen-brush.md`
...
description: "和/書/落ち着いた配信者向けの公式サイト first viewport mock。配信予定、作品/アーカイブ、SNSへつなぐ。"
colors:
  primary: "#171717"
  secondary: "#fafafa"
  surface: "#404040"
...
## Colors
- Primary: `#171717` を世界観の主役色、Live状態、重要アクセントに使う。
- Secondary: `#fafafa` をUI枠、背景レイヤー、補助アクセントに使う。
- Surface: `#404040` を背景/カード面に使う。
...
- The visual identity matches "Zen Brush" and still feels like a usable website.
