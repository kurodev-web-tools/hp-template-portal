# Streamer S: Steampunk Gear Mock Prompt

## Purpose
- このファイルは streamer/s の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/polish/s-steampunk-gear.md`
...
- The visual identity matches "Steampunk Gear" and still feels like a usable website.
