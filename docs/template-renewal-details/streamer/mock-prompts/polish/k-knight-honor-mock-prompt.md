# Streamer K: Knight Honor Mock Prompt

## Purpose
- このファイルは streamer/k の first viewport mock 画像を作るためのプロンプト。
- `design.md` 形式の考え方に合わせ、YAML design tokens + human-readable rationale + image prompt に分ける。
- Source detail: `docs/template-renewal-details/streamer/polish/k-knight-honor.md`
...
---
version: "alpha"
name: "Streamer K: Knight Honor"
description: "騎士/ファンタジー系向けの公式サイト first viewport mock。スケジュール、ファン参加、案件相談へつなぐ。"
colors:
  primary: "#2563eb"
  secondary: "#f3f4f6"
  surface: "#d1d5db"
...
## Colors
- Primary: `#2563eb` を世界観の主役色、Live状態、重要アクセントに使う。
- Secondary: `#f3f4f6` をUI枠、背景レイヤー、補助アクセントに使う。
- Surface: `#d1d5db` を背景/カード面に使う。
...
- The visual identity matches "Knight Honor" and still feels like a usable website.
