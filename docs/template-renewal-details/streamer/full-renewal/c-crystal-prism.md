# Streamer C: Crystal Prism Renewal Detail

## 基本情報
- Category: Streamer
- Template ID: st_c
- Existing path: `templates/streamer/c`
- Current theme name: Crystal Prism
- Renewal decision: Full Renewal
- Source audit: `docs/reviews/PORTAL_CONVERSION_AUDIT_2026-05-03.md`
- Created: 2026-05-03

## 現状の読み取り
既存テーマは「Crystal Prism」。features は Glassmorphism, Prism, Pastel、主要色は #ffd6ff, #e7ffff, #c8b6ff。現行の一覧カードでは見た目の違いは伝わるが、受託制作としての選択理由と申し込み導線をさらに明確にする。

## リニューアルの狙い
- Target audience: 透明感/癒し/歌枠配信者
- Conversion goal: 配信予定、歌枠アーカイブ、SNSフォロー
- Core concept: 透明感/癒し/歌枠配信者 向けの公式サイト。既存の Crystal Prism らしさを保ちつつ、配信予定、SNS、アーカイブ、案件相談へつなぐ。
...
- Color: 既存の #ffd6ff, #e7ffff, #c8b6ff を起点に、CTA色と装飾色を分ける。
...
- Audience language: 透明感/癒し/歌枠配信者 のファンが読む言葉と、企業担当者が読む案件相談の言葉を分ける。
...
- Portal CTA: `plans.html?template=streamer-c&plan=standard` へ接続する想定。
- Demo CTA: fixed bottom CTA または Hero CTA から「このテンプレートで制作相談」へ戻す。

## Motion / Effect
- Full renewal: 世界観演出は Crystal Prism のHeroと1セクションに限定し、配信予定やSNS導線の可読性を優先する。
...
## モック画像方針
必須。first viewport + schedule / clips teaser を 1 枚作る。既存テーマ名「Crystal Prism」が残っていること、CTA が最初の画面に見えること、SPでも成立する情報量であることを確認する。
