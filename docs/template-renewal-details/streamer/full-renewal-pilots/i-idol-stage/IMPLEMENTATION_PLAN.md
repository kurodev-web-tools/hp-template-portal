# Idol Stage Implementation Plan

**Goal:** Idol Stage をモック準拠の高品質な アイドル/歌枠配信者 向け配信者公式サイトへリニューアルする。

**Architecture:** Static-first。`idol live venue and ticket strip` を first viewport の基準にし、Phase 1 で HTML/CSS 構造、Phase 2 で素材と visual fidelity、Phase 3 で軽量 signature motion を追加する。PC はテーマ世界観を優先し、SP は CTA と schedule の到達性を優先する。
...
- Reference: `docs/template-renewal-details/streamer/full-renewal-pilots/i-idol-stage/DESIGN.md`
- Reference: `docs/template-renewal-details/streamer/mockup-image/full-renewal/i-idol-stage-layout-v2.png`
- Reference: `docs/template-renewal-details/streamer/full-renewal/i-idol-stage.md`
- Modify: `public/templates/streamer/i/index.html`
- Create/modify: `public/templates/streamer/i/assets/css/style.css`
- Create/modify if needed: `public/templates/streamer/i/assets/js/script.js`
- Create if needed: `public/templates/streamer/i/assets/img/`
