# Lunar Phase Implementation Plan - Symphony Task
...
Lunar Phase をモック準拠の高品質な 月/占い/夜系配信者 向け配信者公式サイトへリニューアルする。

Static-first。`moon phase observatory` を first viewport の基準にし、Phase 1 で HTML/CSS 構造、Phase 2 で素材と visual fidelity、Phase 3 で軽量 signature motion を追加する。PC はテーマ世界観を優先し、SP は CTA と schedule の到達性を優先する。

## Source Docs

Reference these planning docs when implementing:

- `docs/template-renewal-details/streamer/full-renewal-pilots/l-lunar-phase/DESIGN.md`
- `docs/template-renewal-details/streamer/full-renewal-pilots/l-lunar-phase/IMPLEMENTATION_PLAN.md`
- `docs/template-renewal-details/streamer/mockup-image/full-renewal/l-lunar-phase-layout-v2.png`
- `docs/template-renewal-details/streamer/full-renewal/l-lunar-phase.md`
