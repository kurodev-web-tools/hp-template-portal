...
**Goal:** Quest Log を冒険者ギルド掲示板型の配信者公式サイトへリニューアルする。

**Architecture:** Static-first。Quest board grid を作り、LP と下層ページの両方へ展開できる category/tab 構造にする。素材は parchment / wood / seal に限定する。
...
- Reference: `docs/template-renewal-details/streamer/full-renewal-pilots/q-quest-log/DESIGN.md`
- Reference: `docs/template-renewal-details/streamer/mockup-image/full-renewal/q-quest-log-layout-v2.png`
- Reference: `docs/template-renewal-details/streamer/full-renewal/q-quest-log.md`
- Modify: `public/templates/streamer/q/index.html`
- Create/modify: `public/templates/streamer/q/assets/css/style.css`
- Create/modify if needed: `public/templates/streamer/q/assets/js/script.js`
- Create if needed: `public/templates/streamer/q/assets/img/`
