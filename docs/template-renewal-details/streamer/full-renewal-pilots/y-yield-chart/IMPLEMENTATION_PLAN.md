# Yield Chart Implementation Plan

**Goal:** Yield Chart をモック準拠の高品質な 投資/分析配信者 向け配信者公式サイトへリニューアルする。

**Architecture:** Static-first。`creator growth analytics board` を first viewport の基準にし、Phase 1 で HTML/CSS 構造、Phase 2 で素材と visual fidelity、Phase 3 で軽量 signature motion を追加する。PC はテーマ世界観を優先し、SP は CTA と schedule の到達性を優先する。
...
- Reference: `docs/template-renewal-details/streamer/full-renewal-pilots/y-yield-chart/DESIGN.md`
- Reference: `docs/template-renewal-details/streamer/mockup-image/full-renewal/y-yield-chart-layout-v2.png`
- Reference: `docs/template-renewal-details/streamer/full-renewal/y-yield-chart.md`
- Modify: `public/templates/streamer/y/index.html`
- Create/modify: `public/templates/streamer/y/assets/css/style.css`
- Create/modify if needed: `public/templates/streamer/y/assets/js/script.js`
- Create if needed: `public/templates/streamer/y/assets/img/`
