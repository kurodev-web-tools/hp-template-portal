# Metallic Chrome Implementation Plan - Symphony Task
...
Metallic Chrome をモック準拠の高品質な 近未来/ファッション系 向け配信者公式サイトへリニューアルする。

Static-first。`chrome showroom command display` を first viewport の基準にし、Phase 1 で HTML/CSS 構造、Phase 2 で素材と visual fidelity、Phase 3 で軽量 signature motion を追加する。PC はテーマ世界観を優先し、SP は CTA と schedule の到達性を優先する。

## Source Docs

Reference these planning docs when implementing:

- `docs/template-renewal-details/streamer/full-renewal-pilots/m-metallic-chrome/DESIGN.md`
- `docs/template-renewal-details/streamer/full-renewal-pilots/m-metallic-chrome/IMPLEMENTATION_PLAN.md`
- `docs/template-renewal-details/streamer/mockup-image/full-renewal/m-metallic-chrome-layout-v2.png`
- `docs/template-renewal-details/streamer/full-renewal/m-metallic-chrome.md`
