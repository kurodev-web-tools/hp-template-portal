# Rogue Stealth Implementation Plan

**Goal:** Rogue Stealth をモック準拠の高品質な ステルス/スパイ系 向け配信者公式サイトへリニューアルする。

**Architecture:** Static-first。`stealth mission dossier` を first viewport の基準にし、Phase 1 で HTML/CSS 構造、Phase 2 で素材と visual fidelity、Phase 3 で軽量 signature motion を追加する。PC はテーマ世界観を優先し、SP は CTA と schedule の到達性を優先する。
...
- Reference: `docs/template-renewal-details/streamer/full-renewal-pilots/r-rogue-stealth/DESIGN.md`
- Reference: `docs/template-renewal-details/streamer/mockup-image/full-renewal/r-rogue-stealth-layout-v2.png`
- Reference: `docs/template-renewal-details/streamer/full-renewal/r-rogue-stealth.md`
- Modify: `public/templates/streamer/r/index.html`
- Create/modify: `public/templates/streamer/r/assets/css/style.css`
- Create/modify if needed: `public/templates/streamer/r/assets/js/script.js`
- Create if needed: `public/templates/streamer/r/assets/img/`
