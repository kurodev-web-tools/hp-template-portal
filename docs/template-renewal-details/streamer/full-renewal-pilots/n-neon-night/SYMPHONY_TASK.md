# Neon Night Implementation Plan - Symphony Task
...
Neon Night をモック準拠の高品質な 夜遊び/クラブ配信者 向け配信者公式サイトへリニューアルする。

Static-first。`neon nightlife sign street` を first viewport の基準にし、Phase 1 で HTML/CSS 構造、Phase 2 で素材と visual fidelity、Phase 3 で軽量 signature motion を追加する。PC はテーマ世界観を優先し、SP は CTA と schedule の到達性を優先する。

## Source Docs

Reference these planning docs when implementing:

- `docs/template-renewal-details/streamer/full-renewal-pilots/n-neon-night/DESIGN.md`
- `docs/template-renewal-details/streamer/full-renewal-pilots/n-neon-night/IMPLEMENTATION_PLAN.md`
- `docs/template-renewal-details/streamer/mockup-image/full-renewal/n-neon-night-layout-v2.png`
- `docs/template-renewal-details/streamer/full-renewal/n-neon-night.md`
