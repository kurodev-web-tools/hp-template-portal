# Business A: Authentic Renewal Detail

## 基本情報
- Category: Business
- Template ID: bus_a
- Existing path: `templates/business/a`
- Current theme name: Authentic
- Renewal decision: Partial Renewal
- Source audit: `docs/reviews/PORTAL_CONVERSION_AUDIT_2026-05-03.md`
- Created: 2026-05-03

## 現状の読み取り
既存テーマは「Authentic」。features は Corporate, Trust, Blue Theme、主要色は #003366, #ffffff, #f5f5f5。現行の一覧カードでは見た目の違いは伝わるが、受託制作としての選択理由と申し込み導線をさらに明確にする。

## リニューアルの狙い
- Target audience: 士業、戦略コンサル、堅実なBtoB企業
- Conversion goal: 初回相談、資料請求、顧問相談の3導線を分ける。
- Core concept: 信頼の蓄積を見せるコーポレートサイト。派手な演出より、実績、担当領域、相談しやすさを優先する。
...
- Visual hook: クラシックな余白、縦長の見出し、控えめな罫線。Hero は実写風の建築/会議室/資料モチーフで重心を作る。過度な演出ではなく業種固有の写真/数値/証拠で差別化する。
- Primary actions: Conversion goal (初回相談、資料請求、顧問相談の3導線を分ける) に沿うCTAを置く。
...
- Visual direction: クラシックな余白、縦長の見出し、控えめな罫線。Hero は実写風の建築/会議室/資料モチーフで重心を作る。
- First viewport: 誰向けのテンプレートか、何ができるか、どの行動を取るべきかを5秒で理解できる状態にする。
- Mobile: CTA、主要情報、信頼材料を先に出す。PCの演出を単純縮小しない。
- Color: 既存の #003366, #ffffff, #f5f5f5 を起点に、CTA色と装飾色を分ける。

## Visual System
- Color system: #003366, #ffffff, #f5f5f5 を基調に、信頼色とCTA色を分ける。業種とズレる彩度は抑える。
...
- Audience language: 士業、戦略コンサル、堅実なBtoB企業 が安心して相談できる言葉にする。
- Required concrete details: Conversion goal (初回相談、資料請求、顧問相談の3導線を分ける) に必要な資料、事例、費用目安、対応範囲。
- Avoid: 汎用的な企業理念だけで、何を依頼できるか分からない状態。

## CTA / 導線
- Primary CTA: 無料相談する / 見積もり相談する
- Secondary CTA: 資料請求、導入事例、サービス詳細
- Portal CTA: `plans.html?template=business-a&plan=standard` へ接続する想定。
