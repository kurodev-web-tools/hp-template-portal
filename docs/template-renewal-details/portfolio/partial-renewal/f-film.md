# Portfolio F: Film Renewal Detail

## 基本情報
- Category: Portfolio
- Template ID: pf_f
- Existing path: `templates/portfolio/f`
- Current theme name: Film
- Renewal decision: Partial Renewal
- Source audit: `docs/reviews/PORTAL_CONVERSION_AUDIT_2026-05-03.md`
- Created: 2026-05-03

## 現状の読み取り
既存テーマは「Film」。features は Film, Horizontal Scroll, Photo、主要色は #262626, #171717, #e5e5e5。現行の一覧カードでは見た目の違いは伝わるが、受託制作としての選択理由と申し込み導線をさらに明確にする。

## リニューアルの狙い
- Target audience: 写真家/映像作家
- Conversion goal: 作品閲覧、問い合わせ、案件相談、プロフィール理解
- Core concept: 写真家/映像作家 の作品サイト。見た目だけでなく、誰に何を依頼できるかを伝える。
...
- Visual hook: 横スクロールを残しつつCTAへ戻れる。作品を隠す装飾や過剰な文字被せは避ける。
...
- Visual direction: 横スクロールを残しつつCTAへ戻れる
- First viewport: 誰向けのテンプレートか、何ができるか、どの行動を取るべきかを5秒で理解できる状態にする。
- Mobile: CTA、主要情報、信頼材料を先に出す。PCの演出を単純縮小しない。
- Color: 既存の #262626, #171717, #e5e5e5 を起点に、CTA色と装飾色を分ける。

## Visual System
- Color system: #262626, #171717, #e5e5e5 は作品の邪魔をしない背景/アクセントに限定する。
...
- Audience language: 写真家/映像作家 が「この人に何を頼めるか」を判断できる言葉にする。
...
- Portal CTA: `plans.html?template=portfolio-f&plan=standard` へ接続する想定。
