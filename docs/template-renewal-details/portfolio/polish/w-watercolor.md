# Portfolio W: Watercolor Renewal Detail

## 基本情報
- Category: Portfolio
- Template ID: pf_w
- Existing path: `templates/portfolio/w`
- Current theme name: Watercolor
- Renewal decision: Polish
- Source audit: `docs/reviews/PORTAL_CONVERSION_AUDIT_2026-05-03.md`
- Created: 2026-05-03

## 現状の読み取り
既存テーマは「Watercolor」。features は Watercolor, Mask, Painter、主要色は #fdf4ff, #c026d3, #fbcfe8。現行の一覧カードでは見た目の違いは伝わるが、受託制作としての選択理由と申し込み導線をさらに明確にする。

## リニューアルの狙い
- Target audience: 画家/水彩作家
- Conversion goal: 作品閲覧、問い合わせ、案件相談、プロフィール理解
- Core concept: 画家/水彩作家 の作品サイト。見た目だけでなく、誰に何を依頼できるかを伝える。
...
- Visual hook: 作品購入/依頼/展示導線。作品を隠す装飾や過剰な文字被せは避ける。
...
- Visual direction: 作品購入/依頼/展示導線
- First viewport: 誰向けのテンプレートか、何ができるか、どの行動を取るべきかを5秒で理解できる状態にする。
- Mobile: CTA、主要情報、信頼材料を先に出す。PCの演出を単純縮小しない。
- Color: 既存の #fdf4ff, #c026d3, #fbcfe8 を起点に、CTA色と装飾色を分ける。

## Visual System
- Color system: #fdf4ff, #c026d3, #fbcfe8 は作品の邪魔をしない背景/アクセントに限定する。
...
- Audience language: 画家/水彩作家 が「この人に何を頼めるか」を判断できる言葉にする。
...
- Portal CTA: `plans.html?template=portfolio-w&plan=standard` へ接続する想定。
