# Portfolio P: Paper Renewal Detail

## 基本情報
- Category: Portfolio
- Template ID: pf_p
- Existing path: `templates/portfolio/p`
- Current theme name: Paper
- Renewal decision: Polish
- Source audit: `docs/reviews/PORTAL_CONVERSION_AUDIT_2026-05-03.md`
- Created: 2026-05-03

## 現状の読み取り
既存テーマは「Paper」。features は Paper, Shadow, Illustrator、主要色は #fefce8, #78350f, #fef08a。現行の一覧カードでは見た目の違いは伝わるが、受託制作としての選択理由と申し込み導線をさらに明確にする。

## リニューアルの狙い
- Target audience: イラストレーター
- Conversion goal: 作品閲覧、問い合わせ、案件相談、プロフィール理解
- Core concept: イラストレーター の作品サイト。見た目だけでなく、誰に何を依頼できるかを伝える。
...
- Visual hook: 依頼種別、価格目安、作品カテゴリ。作品を隠す装飾や過剰な文字被せは避ける。
...
- Visual direction: 依頼種別、価格目安、作品カテゴリ
- First viewport: 誰向けのテンプレートか、何ができるか、どの行動を取るべきかを5秒で理解できる状態にする。
- Mobile: CTA、主要情報、信頼材料を先に出す。PCの演出を単純縮小しない。
- Color: 既存の #fefce8, #78350f, #fef08a を起点に、CTA色と装飾色を分ける。

## Visual System
- Color system: #fefce8, #78350f, #fef08a は作品の邪魔をしない背景/アクセントに限定する。
...
- Audience language: イラストレーター が「この人に何を頼めるか」を判断できる言葉にする。
...
- Portal CTA: `plans.html?template=portfolio-p&plan=standard` へ接続する想定。
